// mock of USDT for testing, necessary due to non compliance (not returning
// true for successful transfers)
// updated to 0.5 (basically adding emits to events and using constructor)
// deploy TetherToken, initialSupply (constructor parameter) will be minted to deployer.
